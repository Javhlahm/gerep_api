...
public class IncidenciaControlador {
    ...
    public ResponseEntity<List<Incidencia>> listarIncidenciasPorAlumno(@PathVariable Long alumnoId) {
        List<Incidencia> incidencias = incidenciaServicio.obtenerIncidenciasPorAlumno(alumnoId);
